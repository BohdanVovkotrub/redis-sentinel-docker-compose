...
REM Generate docker-compose-redis-sentinel2.yml
set "TEMPLATE_COMPOSE=compose.redis-sentinel2.template.yml"
set "OUTPUT_COMPOSE=docker-compose-redis-sentinel2.yml"
